...
In the package, we provide a function `CreateTrans()` to help you create these transitions. You need to provide subject ID, age, current state, indicator of death and total number of states. Here is an example of this function's usage.
...
Without giving names of each state, the life table will appear as follows:

```{r, echo = FALSE}

lifetable <- data.frame(V1 = c(12.26391,12.98282,11.97415,11.36613,10.32153,11.22679	),
                        V2 = c(12.37167, 13.26774, 13.92443, 13.62579, 13.61575, 13.41254),
                        V3 = c(35.37205, 33.85567, 34.11296, 35.02107, 36.06585, 35.46204))
